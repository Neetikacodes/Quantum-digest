...
async function tryFetchOpenAlex() {
  const url = 'https://api.openalex.org/works?filter=title.search:%22quantum%20computing%22|title.search:%22quantum%20algorithm%22|title.search:qubit&sort=publication_date:desc&per-page=10&mailto=quantumdigest.bot@gmail.com';
